...
exports.run = async(client, message, args, ayar, emoji) => {
  ...
  if (!message.member.roles.cache.has(veri.teyityetkilisi) && !message.member.roles.cache.has(veri.admin) && !message.member.roles.cache.has(veri.yönetici))
